...
const PAGE_SIZE = 20;
const BASE_PATH = "/dashboard/inquiries";
        ...
        <div className="space-y-6">
            <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                    {total} general enquir{total === 1 ? "y" : "ies"} from the website
                </p>
            </div>

            <LeadTableToolbar />
            <LeadTable items={items} emptyMessage="No inquiries match these filters." />
